...
if __name__ == "__main__":
    ...
    # # set experiment
    exp = mlflow.set_experiment(experiment_name='Exp_5')
    ...
    mlflow.set_tag('version','0.1')  # for single tag
    mlflow.set_tags({'release.version':'1','library':'sklearn','operation':'ML'})
